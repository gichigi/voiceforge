...
First, analyze the business context:
1. What industry is ${data.businessName} in and what tone would resonate with their audience?
2. What emotional responses should their communication evoke?
3. How do their values translate into communication style?

Based on this analysis, generate a concise executive summary (1-2 sentences) that captures the essence of ${data.businessName}'s brand voice.

Then, create THREE clear, actionable brand voice pillars that align with ${data.businessName}'s industry, values, and audience. Each pillar should be immediately useful for content creation.

IMPORTANT GUIDELINES FOR PILLARS:
- Each pillar MUST be a SINGLE WORD adjective (like: Bold, Playful, Sophisticated, Adventurous, Direct, Empowering, Quirky, Inspirational, Vibrant, Provocative, Witty, Passionate, Candid, Elegant, Minimalist, Energetic, Thoughtful, Confident, Approachable, Conversational, Authoritative, Warm, Precise, Clever, Sincere, Enthusiastic, Calm, Respectful, Optimistic, Pragmatic)
- Choose pillars that work well together as a cohesive set for ${data.businessName}
- Each pillar should be practical and immediately applicable to content creation
...
IMPORTANT: 
- Each pillar MUST be a SINGLE WORD adjective
- The pillars should work together as a cohesive set
